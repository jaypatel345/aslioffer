  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="relative overflow-hidden pt-8 pb-4 text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/60 border border-emerald-800/60 text-emerald-400 text-xs font-semibold mb-6">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Link
            to="/upload"
            className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-bold text-sm tracking-wide shadow-lg shadow-emerald-950/60 transition-all flex items-center gap-2"
          >
          ...
          <Link
            ...
            className="px-6 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-white font-medium text-sm transition-colors flex items-center gap-2"
          >
      ...
      <section className="max-w-4xl mx-auto">
        <div className="glass-panel rounded-2xl p-6 sm:p-8 border-l-4 border-l-emerald-400">
          <h2 className="text-lg font-bold text-white mb-2">The AsliOffer Principle</h2>
          <blockquote className="text-slate-300 text-sm sm:text-base italic leading-relaxed">
          ...
          <div className="mt-4 flex items-center gap-6 text-xs text-slate-400 font-mono">
            <span>✓ MCA & CIN Checks</span>
            <span>✓ Domain Alignment</span>
            <span>✓ Advance Fee Detection</span>
            <span>✓ Salary Outlier Benchmarking</span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white">Multi-Agent Investigation Pipeline</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="glass-card rounded-xl p-5 border-t-2 border-t-blue-500">
            <div className="w-9 h-9 rounded-lg bg-blue-950/80 flex items-center justify-center text-blue-400 mb-3">
              <Building className="w-5 h-5" />
            </div>
            <h3 className="text-base font-semibold text-white">Company Agent</h3>
          ...
          <div className="glass-card rounded-xl p-5 border-t-2 border-t-purple-500">
            <div className="w-9 h-9 rounded-lg bg-purple-950/80 flex items-center justify-center text-purple-400 mb-3">
              <UserCheck className="w-5 h-5" />
            </div>
            <h3 className="text-base font-semibold text-white">Recruiter Agent</h3>
            <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
          ...
          <div className="glass-card rounded-xl p-5 border-t-2 border-t-emerald-500">
            <div className="w-9 h-9 rounded-lg bg-emerald-950/80 flex items-center justify-center text-emerald-400 mb-3">
              <IndianRupee className="w-5 h-5" />
            </div>
            <h3 className="text-base font-semibold text-white">Salary Agent</h3>
            <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
          ...
          <div className="glass-card rounded-xl p-5 border-t-2 border-t-rose-500">
            <div className="w-9 h-9 rounded-lg bg-rose-950/80 flex items-center justify-center text-rose-400 mb-3">
              <AlertTriangle className="w-5 h-5" />
            </div>
            <h3 className="text-base font-semibold text-white">Scam Agent</h3>
            <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-white">Sample Offer Verifications</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Card 1: Scam */}
          <div className="glass-card rounded-2xl p-6 border-slate-800 hover:border-slate-700 transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-slate-400 font-mono">ID #101 • PDF Offer</span>
            ...
            <div className="mt-5 pt-4 border-t border-slate-800/80 flex items-center justify-between">
              <span className="text-xs text-slate-400">4 Evidence Points</span>
              <Link
                to="/offers/101/report"
          ...
          <div className="glass-card rounded-2xl p-6 border-slate-800 hover:border-slate-700 transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-slate-400 font-mono">ID #102 • Email Offer</span>
