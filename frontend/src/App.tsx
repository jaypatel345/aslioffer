        ...
        <footer className="border-t border-slate-200 bg-white/90 py-8 mt-12 text-xs text-slate-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-700">AsliOffer</span>
            ...
            <div>
              Built for <strong className="text-slate-700">SerpApi India Hackathon 2026</strong> (AI Agents Track)
            </div>
          </div>
        </footer>
      </div>
